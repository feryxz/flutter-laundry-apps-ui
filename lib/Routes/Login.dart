              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      "Login",
                      style: TextStyle(fontSize: 30, color: Color(0XFF0E2433)),
                    ),
                    SizedBox(
                      height: 30,
                    ),
                      ...
                      child: Align(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              color: Color(0XFF0E2433),
                              boxShadow: [
                                BoxShadow(offset: Offset(0, 2), blurRadius: 2)
                              ]),
                          child: Text(
                            "Login",
      ...
      child: Padding(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            hintText: !EmailNode.hasFocus ? "feryxz.dev@gmail.com" : null,
            ...
            border:
                EmailNode.hasFocus ? InputBorder.none : UnderlineInputBorder(),
            prefixIcon: Icon(
              Icons.mail_outline,
              color: Color(0XFF0E2433),
            ),
